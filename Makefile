...
SRC_MEMORY			= memory_alloc.c memory_free.c window_alloc.c textures_alloc.c \
							image_alloc.c ray_alloc.c ray_free.c
...
OBJS_PATH		= obj$(DIRSEP)

OBJ_NAME		= $(SRCS:%.c= %.o)

OBJ				= $(addprefix $(OBJS_PATH), $(OBJ_NAME))
...
clean: libft_clean minilibx_clean
	@$(RM) -r $(OBJ_PATH) $(OBJS_PATH) 2> $(DIRSEP)dev$(DIRSEP)null || true
	@echo "$(PURPLE)Object files have been removed.$(DEFCOLOR)"

fclean: libft_fclean minilibx_clean
	@$(RM) -r $(OBJ_PATH) $(OBJS_PATH) 2> $(DIRSEP)dev$(DIRSEP)null || true
	@$(RM) $(NAME) $(NAME) 2> $(DIRSEP)dev$(DIRSEP)null || true
